    ...
    sections: [
        ...
        body: [
          'We do not sell your data. We share it only with service providers who process it on our behalf under a data processing agreement:',
          {
            list: [
              ...
              'Resend — delivery of transactional emails (invitations, quotes, invoices, reminders).',
            ],
          },
        ],
      },
      ...
      },
      {
        ...
        body: [
          ...
          'You can export your account data or request account deletion yourself at any time, from Settings > Your data in the app.',
          `For any other request, contact ${LEGAL_CONTACT_EMAIL}. You also have the right to lodge a complaint with your local data protection authority (for the Netherlands, the Autoriteit Persoonsgegevens).`,
        ],
      },
      {
        h: '8. Security',
...
const NL = {
  privacy: {
    ...
    sections: [
      ...
      { h: '7. Je rechten', body: ['Op grond van de AVG heb je recht op inzage, correctie, verwijdering, beperking of bezwaar tegen de verwerking van je gegevens, en recht op overdraagbaarheid.', 'Je kunt je accountgegevens zelf exporteren of verwijdering van je account aanvragen, op elk moment, via Instellingen > Jouw gegevens in de app.', `Voor andere verzoeken mail je ${LEGAL_CONTACT_EMAIL}. Je hebt ook het recht om een klacht in te dienen bij de Autoriteit Persoonsgegevens.`] },
...
const FR = {
  privacy: {
    ...
    sections: [
      ...
      { h: '7. Vos droits', body: ['En vertu du RGPD, vous avez le droit d’accéder à vos données, de les rectifier, de les effacer, d’en limiter le traitement ou de vous y opposer, ainsi qu’un droit à la portabilité.', 'Vous pouvez exporter vos données de compte ou demander la suppression de votre compte vous-même, à tout moment, depuis Paramètres > Vos données dans l’application.', `Pour toute autre demande, écrivez à ${LEGAL_CONTACT_EMAIL}. Vous avez aussi le droit d’introduire une réclamation auprès de votre autorité de protection des données (par ex. la CNIL en France, l’Autoriteit Persoonsgegevens aux Pays-Bas).`] },
